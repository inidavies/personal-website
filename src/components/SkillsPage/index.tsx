  ...
  return (
    <div id="skills" className="mypage alternate-page aboutAndSkills">
      <div id="skillSummary">
        <h2>my tech stack.</h2>
        <p>
          I am proficient in other technologies and tools such as <span className="fw-bold">Java</span>, <span className="fw-bold">C++</span>, <span className="fw-bold">SQL</span>, MongoDB, Postman, Intellij, and <span className="fw-bold">CI/CD pipelines</span>.
